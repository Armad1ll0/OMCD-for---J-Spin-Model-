# -*- coding: utf-8 -*-
"""
Created on Thu Jul  8 19:41:52 2021
...
# =============================================================================
#             previous = d0
#             holding_place = d0*0.7
# =============================================================================
            #d0 = math.floor(d0*0.7)
            d0 = d0-1 
...
for i in range(samples):
    ...
    #print('Our initial spin glass configuration is: ' + str(spin_glass_box_original))
    #initial_config(spin_glass_box_original)
    #this is the Jij matrix, there are 3 times as many links between particles as there are particles in 3d so we need 
    #to have 3 inputs first one is for x, second for y, and third for z. 
...
# =============================================================================
#     J_matrix_x = np.asarray(J_matrix_x)
#     J_matrix_y = [[[np.random.choice([1, -1]) for iy in range(nx)] for jy in range(nx)] for ky in range(nx)]
#     J_matrix_y = np.asarray(J_matrix_y)
#     J_matrix_z = [[[np.random.choice([1, -1]) for iz in range(nx)] for jz in range(nx)] for kz in range(nx)]
#     J_matrix_z = np.asarray(J_matrix_z)
# =============================================================================
    ...
    for j in range(d0): #need to change it to d0-1 
        ...
        final_results = OMCD(d0, spin_glass_box_medium, medium_total_energy, acceptance, rejection, number_rejections_this_round)
        d0 = d0 - 1 
        #print('Starting d0 is now ' + str(d0))
