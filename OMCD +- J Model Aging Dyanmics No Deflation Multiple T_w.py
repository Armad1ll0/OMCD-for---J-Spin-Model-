# -*- coding: utf-8 -*-
"""
Created on Mon Jul 26 13:48:59 2021
...
def OMCD(spin_glass_box_original, spin_glass_box_medium, J_matrix, initial_total_energy, medium_total_energy, graph_energy, d0, d0_start_value, acceptance, rejection, monte_carlo_steps):
    ...
    while d0 > 0:
        ...
        if total_count == 10000:
            place_holder_1 = spin_glass_box_medium
        elif total_count == 20000:
            place_holder_2 = spin_glass_box_medium
        elif total_count == 30000:
            place_holder_3 = spin_glass_box_medium
        elif total_count == 40000:
            place_holder_4 = spin_glass_box_medium
        if total_count % 1000 == 0 and total_count > 10000:
            multiply_1 = place_holder_1*spin_glass_box_medium
            summed_1 = np.sum(multiply_1)
            cosine_sim_1 = summed_1/(nx**3)
            cosine_sims_1.append(cosine_sim_1)
            steps_1.append(total_count)
            #spin_glass_box_original = spin_glass_box_medium
        if total_count % 1000 == 0 and total_count > 20000:
            multiply_2 = place_holder_2*spin_glass_box_medium
            summed_2 = np.sum(multiply_2)
            cosine_sim_2 = summed_2/(nx**3)
            cosine_sims_2.append(cosine_sim_2)
            steps_2.append(total_count)
            #spin_glass_box_original = spin_glass_box_medium
        if total_count % 1000 == 0 and total_count > 30000:
            multiply_3 = place_holder_3*spin_glass_box_medium
            summed_3 = np.sum(multiply_3)
            cosine_sim_3 = summed_3/(nx**3)
            cosine_sims_3.append(cosine_sim_3)
            steps_3.append(total_count)
            #spin_glass_box_original = spin_glass_box_medium
        if total_count % 1000 == 0 and total_count > 40000:
            multiply_4 = place_holder_4*spin_glass_box_medium
            summed_4 = np.sum(multiply_4)
            cosine_sim_4 = summed_4/(nx**3)
            cosine_sims_4.append(cosine_sim_4)
            steps_4.append(total_count)
            #spin_glass_box_original = spin_glass_box_medium
    ...
    return spin_glass_box_medium, medium_total_energy, energy_change, d0_when_energy_change, steps_1, d0_step_change, cosine_sims_1, cosine_sims_2, cosine_sims_3, cosine_sims_4, steps_2, steps_3, steps_4
...
def cosine_sim_graph(cosine_averages_1, cosine_variances_1, cosine_averages_2, cosine_variances_2, cosine_averages_3, cosine_variances_3, cosine_averages_4, cosine_variances_4, steps_1, steps_2, steps_3, steps_4):
    plt.scatter(steps_1, cosine_averages_1, label="T_w = 10,000")
    plt.errorbar(steps_1,cosine_averages_1, yerr=cosine_variances_1, linestyle="None")
    plt.scatter(steps_2, cosine_averages_2, label="T_w = 20,000")
    plt.errorbar(steps_2,cosine_averages_2, yerr=cosine_variances_2, linestyle="None")
    plt.scatter(steps_3, cosine_averages_3, label="T_w = 30,000")
    plt.errorbar(steps_3,cosine_averages_3, yerr=cosine_variances_3, linestyle="None")
    plt.scatter(steps_4, cosine_averages_4, label="T_w = 40,000")
    plt.errorbar(steps_4,cosine_averages_4, yerr=cosine_variances_4, linestyle="None")
    plt.xscale('log')
    plt.legend()
...
def cosine_sim_graph_no_var(cosine_averages_1, cosine_averages_2, cosine_averages_3, cosine_averages_4, steps_1, steps_2, steps_3, steps_4):
    plt.scatter(steps_1, cosine_averages_1, label="T_w = 10,000")
    plt.scatter(steps_2, cosine_averages_2, label="T_w = 20,000")
    plt.scatter(steps_3, cosine_averages_3, label="T_w = 30,000")
    plt.scatter(steps_4, cosine_averages_4, label="T_w = 40,000")
...
if __name__ == "__main__":
    ...
    with multiprocessing.Pool(num_cores) as pool:
        ...
        steps_1 = [x[4] for x in results]
        steps_2 = [x[10] for x in results]
        steps_3 = [x[11] for x in results]
        steps_4 = [x[12] for x in results]
        steps_1 = steps_1[0]
        steps_2 = steps_2[0]
        steps_3 = steps_3[0]
        steps_4 = steps_4[0]
        ...
        cosine_sims_1 = [x[6] for x in results]
        cosine_sims_2 = [x[7] for x in results]
        cosine_sims_3 = [x[8] for x in results]
        cosine_sims_4 = [x[9] for x in results]
        ...
        cosine_sim_graph_no_var(cosine_averages_1, cosine_averages_2, cosine_averages_3, cosine_averages_4, steps_1, steps_2, steps_3, steps_4)
